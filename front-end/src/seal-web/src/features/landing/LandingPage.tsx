    ...
    return (
        ...
        >
            ...
            <div style={{ position: "relative", zIndex: 1, maxWidth: 580, margin: "0 auto" }}>
                <h2 style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "clamp(28px,4vw,52px)", fontWeight: 900, lineHeight: 1.15, marginBottom: 20, color: C.text }}>Boot Up Your<br /><GradientText from={C.green} to={C.blue}>Hackathon Journey</GradientText></h2>
